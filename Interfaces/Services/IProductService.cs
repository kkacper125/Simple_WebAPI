...
public interface IProductService
{
    ...
    public Task<ProductSearchResponseDTO> GetProductsBySearchAsync(string? name, uint? minPrice, uint? maxPrice, int offset=0, int limit=5);
    public Task<ProductPricesDTO> GetProductsPricesAsync();
